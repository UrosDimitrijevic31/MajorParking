...
export const Incaso = (): JSX.Element => {
    ...
    const showTickets = (): void => {
        ...
        getIncaassoTickets({
            ...
            download(tickets);
            markedTickets.splice(0, markedTickets.length);
    ...
    return (
        <section className="inspection">
            <header>
                <h2 className="heading heading--main">{t("incasso.label")}</h2>
            </header>
                        ...
                        >
                            ...
                            <form onSubmit={handleAddActionSubmit}>
                                ...
                                <Checkbox
                                    ...
                                    defaultChecked={modalAddAction.inkassoSent}
                                    onChange={handleAddActionDataChange.bind(
                                        this,
                                        "inkassoSent",
